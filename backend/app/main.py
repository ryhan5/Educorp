...
from app.routers import skills, planner, interview, simulator, aws_test, learning_pack
...
app.include_router(learning_pack.router, prefix="/api", tags=["learning_pack"])
